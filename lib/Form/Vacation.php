...
class Ingo_Form_Vacation extends Ingo_Form_Base
{
    ...
    public function __construct($vars, $title = '', $name = null, $features = null)
    {
        ...
        if ($this->hasFeature('reason')) {
            $v = $this->addVariable(_("Reason:"), 'reason', 'longtext', true, false, _("You can use placeholders like %NAME% in the vacation message. See the online help for details."), [10, 40]);
