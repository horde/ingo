                            ...
                            case 'Ingo_Rule_User_Move':
                                ...
                                if ($this->_params['show_filter_msg']) {
                                    foreach ($fetch as $msg) {
                                        ...
                                        $notification->push(
                                            sprintf(
                                                _("Filter activity: The message \"%s\" from \"%s\" has been moved to the folder \"%s\"."),
                                    ...
                                    $notification->push(sprintf(
                                        _("Filter activity: %s message(s) have been moved to the folder \"%s\"."),
                                        count($indices),
                                        $mbox
                                    ), 'horde.message');
                                }
                            ...
                            case 'Ingo_Rule_User_Discard':
                                ...
                                if ($this->_params['show_filter_msg']) {
                                    foreach ($fetch as $msg) {
                                        ...
                                        $notification->push(
                                            sprintf(
                                                _("Filter activity: The message \"%s\" from \"%s\" has been deleted."),
                                                !empty($envelope->subject) ? Horde_Mime::decode($envelope->subject) : _("[No Subject]"),
                                                !empty($envelope->from) ? strval($envelope->from) : _("[No Sender]")
                                            ),
                                            'horde.message'
                            ...
                            case 'Ingo_Rule_User_MoveKeep':
                                ...
                                if ($this->_params['show_filter_msg']) {
                                    ...
                                    foreach ($fetch as $msg) {
                                        ...
                                        $notification->push(
                                            sprintf(
                                                _("Filter activity: The message \"%s\" from \"%s\" has been copied to the folder \"%s\"."),
                                                !empty($envelope->subject) ? Horde_Mime::decode($envelope->subject) : _("[No Subject]"),
                                                !empty($envelope->from) ? strval($envelope->from) : _("[No Sender]"),
                                                $mbox
                                            ),
